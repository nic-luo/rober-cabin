...
public class DataFormElement implements DataFormStamp,Serializable,Cloneable{
    ...
    public static class FormElementUIHint implements Serializable,Cloneable{
        ...
        /**
         * 媒体查询,指导限制最小屏幕的最小尺寸,目前允许的值有:
         * xs=[特别小的设备(手机竖屏)]Extra small devices (portrait phones, less than 576px)
         * sm=[小的设备(手机横屏)]Small devices (landscape phones, less than 768px)
         * md=[中型设备(平板设备)]Medium devices (tablets, less than 992px)
         * lg=[大的设备(普通桌面机)]Large devices (desktops, less than 1200px)
         * xl=[特别大的设备(宽屏桌面机)]Extra large devices (large desktops)
         *
         * @return string
         */
